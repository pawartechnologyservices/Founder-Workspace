      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-background via-background to-primary/5 py-20 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
            <div className="absolute -top-40 -right-40 w-80 h-80 bg-green-500/10 rounded-full blur-3xl animate-pulse-slow"></div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-emerald-500/5 rounded-full blur-3xl animate-pulse-slow delay-500"></div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8 animate-fade-in-up">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-primary font-medium animate-fade-in-up delay-200">{config.subtitle}</p>
              ...
              <div className="relative animate-float">
                <div className="relative w-full max-w-2xl mx-auto">
                  ...
                  <div className="absolute -z-10 top-8 left-8 w-full h-full bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xl blur-xl"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-background relative">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Streamline your financial operations with intelligent billing automation
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="border-card-border bg-card/50 backdrop-blur-sm transform hover:scale-105 transition-all duration-500 animate-fade-in-up">
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 mx-auto bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mb-6 animate-pulse">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Automated invoice generation with customizable templates and recurring billing schedules
                  </p>
              ...
              <Card className="border-card-border bg-card/50 backdrop-blur-sm transform hover:scale-105 transition-all duration-500 animate-fade-in-up delay-200">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Support for 50+ payment gateways with secure transaction processing and real-time tracking
                  </p>
                  <div className="inline-flex items-center gap-2 text-sm text-primary font-medium">
                    <Play className="h-4 w-4" />
                    Learn More
              ...
              <Card className="border-card-border bg-card/50 backdrop-blur-sm transform hover:scale-105 transition-all duration-500 animate-fade-in-up delay-400">
                <CardContent className="p-8 text-center">
                  <div className="w-16 h-16 mx-auto bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-6 animate-pulse">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Comprehensive dashboards with revenue tracking, cash flow analysis, and financial reporting
                  </p>
                  <div className="inline-flex items-center gap-2 text-sm text-primary font-medium">
                    <Play className="h-4 w-4" />
                    Learn More
        ...
        <section className="py-20 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <Card className="border-card-border bg-gradient-to-r from-primary/10 via-primary/5 to-green-500/10 backdrop-blur-sm transform hover:scale-105 transition-all duration-500">
