...
export default function CRMWelcome() {
  ...
  const config = {
    ...
    industries: [
      {
        ...
        description: "Personalize customer experiences and increase repeat purchases",
        icon: "🛍️",
      },
      {
        title: "Real Estate",
    ...
    stats: [
      { value: "45%", label: "Faster Lead Conversion" },
      { value: "68%", label: "Increase in Customer Satisfaction" },
      { value: "32%", label: "Reduction in Sales Cycle" },
      ...
      <main>
        ...
        <section className="relative bg-gradient-to-br from-background via-background to-primary/5 py-20 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
            ...
            <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse-slow delay-1000"></div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl animate-pulse-slow delay-500"></div>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative animate-float">
                <div className="relative w-full max-w-2xl mx-auto">
                  ...
                  <div className="absolute -z-10 top-8 left-8 w-full h-full bg-gradient-to-br from-primary/20 to-purple-500/20 rounded-2xl blur-xl"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-background relative">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                Powered by AI and machine learning to supercharge your sales team
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="border-card-border bg-card/50 backdrop-blur-sm transform hover:scale-105 transition-all duration-500 animate-fade-in-up">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Predictive analytics to identify high-value leads and optimize sales strategies
                  </p>
              ...
              <Card className="border-card-border bg-card/50 backdrop-blur-sm transform hover:scale-105 transition-all duration-500 animate-fade-in-up delay-400">
                <CardContent className="p-8 text-center">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Connect with your favorite tools and create a unified customer experience platform
                  </p>
                  <div className="inline-flex items-center gap-2 text-sm text-primary font-medium">
                    <Play className="h-4 w-4" />
                    Learn More
        ...
        <section className="py-20 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-7xl relative z-10">
            <Card className="border-card-border bg-gradient-to-r from-primary/10 via-primary/5 to-purple-500/10 backdrop-blur-sm transform hover:scale-105 transition-all duration-500">
